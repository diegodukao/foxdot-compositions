# https://github.com/Qirky/ten-lines-or-less/blob/master/multiply.py
...
b1 >> sawbass(var([3,2]), dur=PDur(3,8)*2, sus=1/2, cutoff=var([750,2000],32), delay=(0,0.5), oct=(5,[4,6]), amp=var([1,0],[15,1]))  # nice bass pattern
