...
b1 >> sawbass(var.roots, dur=PDur(5,16), cutoff=P[1000,5000][:5], sus=1/2).stop()

b2 >> bass(var.roots, dur=8, amp=0.7).stop()

p1 >> charm(var.roots + P[0, 4, 3, 4, 2][:6], dur=PDur(3,8)*2).penta()
...
p3 >> blip([7, 0, 1, P*(2, 3), 2, 4, 5, P*(6, 7)], dur=[8, 4, 2, 2], sus=8).penta()
